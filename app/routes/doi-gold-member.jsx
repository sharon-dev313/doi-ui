  ...
  const Benifit_data = [
    {
      ...
      paragraph: "Secure and risk-free way to generate capital with a guaranteed 12% annual return backed by DOI's real estate."
    },
    {
      id: 2,
      icon : "/images/doi_gold_members/icons/icon_2.svg",
      title :"Lifetime access to all properties in the DOI ecosystem",
      paragraph: "At 40% off, creating competitive discounts for your customers and increased profitability for you. Unique offerings"
    },
    {
      id: 3,
      icon : "/images/doi_gold_members/icons/icon_3.svg",
      title :"Premier access to DOI's light steel homes",
      paragraph: "Opportunities for cost savings and efficiency through access to DOI's exclusive building materials and construction."
    }
    ,{
      id: 4,
    ...
    },
    {
      ...
      paragraph: "Reducing financial risk and eliminating upfront costs. Full management services, including maintenance.",
    },
    {
      id:6,
...
,
 {
      ...
      paragraph: "Grow your money without exposure to market risks, offering a hassle-free and profitable investment opportunity.",
    },
 {
      id: 8,
       icon : "/images/doi_gold_members/icons/icon_6.svg",
      title :"Access to all properties within the ecosystem",
      paragraph: "At a 40% discount, making travel more affordable for frequent travelers. Convenient amenities already equipped.",
    },
  ]
...
<Doi_Gold_Member 
 ...
 title = {<span>DOI GOLD <br />  Membership</span>}
 list = {DoiGoldMember_data}
footerText = {"Whether you're a novice investor entering into the realm of real estate for the first time, or a seasoned enterprise seeking streamlined investment avenues, our membership offers simplicity coupled with unparalleled security."}
...
{/* Section 3 Start  */}
      <Benefits_List
      title = {<span>Benefits List of Doi <br />Gold Membership</span>}
      paragraph= {"Whether you're a novice investor entering into the realm of real estate for the first time, or a seasoned enterprise seeking streamlined investment avenues"}
      list= {Benifit_data}
