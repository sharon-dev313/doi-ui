  ...
  const ItWorksData = [
    {
      ...
      description:
        "DOI Smart Contracts automate investments with transparent, secure, and tamper proof termse payouts and ownership are always on time.",
    ...
    },
    {
      ...
      description:
        "Built on blockchain infrastructure—your investments, ownership records, and payouts are permanently logged and publicly auditable.",
    ...
    },
    {
      ...
      description:
        "With DOI, every transaction is traceable on the blockchain, giving you full visibility and confidence in where your money goes.",
    ...
    <div>
      ...
      <Guarantee
        ...
        imageParagraph={
          <span>
            {" "}
            DOI <span className="text-doiblue">El hotel</span> in PDC is worth
            on market value at <span className="text-doiblue">1.5 M USD</span>{" "}
            dollars, DOI can only take up to{" "}
            <span className="text-doiblue">1.4 M dollars</span> from its GOLD
            members with this property in collateral. Your money is protected by
            the existing assets. As the ecosystem grows on assets, we can take
            on more money from our members.
          </span>
        }
      ...
      <div className="w-7xl mx-auto py-16 flex flex-col items-center justify-center">
        <Heading
          ...
          how_It_works={false}
        />
        <ItWorks itWorksData={ItWorksData} />
      </div>
      <Gold_Member
