  ...
  return (
   <Card className={`${bgClass} ${className} rounded-3xl shadow-none  `}>
            ...
            <CardBody className="p-6 pt-6 flex flex-col justify-center overflow-visible z-10">
                {mainContent && (
                    <div className="mb-2">
                        <h2 className={` ${mainContent === "$4,000" ? "text-5xl" : "text-2xl"} font-nasa   text-default-900`}>{mainContent}</h2>
                        {subContent && (
                ...
                {progressData && (
                    <div className="w-full relative">
                        ...
                        <div className="text-center relative z-0">
                            <p className="text-default-800 font-medium">{progressData.status}</p>
