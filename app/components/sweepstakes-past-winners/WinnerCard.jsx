                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col items-start gap-1">
                        ...
                        <div className="flex items-center gap-1.5 px-1 py-0.5 rounded-full  text-lime text-lg ">
                            <img src="/images/sweepstakes-past-winners/icons/4.svg" alt={data.username} />
                            <span>{data.wave}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-1 text-default-700">
                        <div className="p-1 rounded-full ">
                            <img src="/images/sweepstakes-past-winners/icons/5.svg" alt={data.username} />
                        </div>
                    ...
                    <div className="flex items-center gap-1 text-default-500">
                        <div className="p-1">
                            <img src="/images/sweepstakes-past-winners/icons/6.svg" alt={data.username} />
                        </div>
                    ...
                    <div className="flex items-center gap-1 text-default-500">
                        <div className="p-1">
                            <img src="/images/sweepstakes-past-winners/icons/7.svg" alt={data.username} />
                        </div>
