...
const Gold_Member = ({title, GoldTitle , paragraph1, paragraph2 , ButtonText , ButtonFunction}) => {
  return (
     <div className="max-w-7xl  mx-auto px-4 overflow-hidden relative bg-black my-16 rounded-4xl sm:px-6 py-20 flex flex-col justify-center items-center ">
      ...
      blur-[100px]">
             ...
             <h1 className="text-5xl text-white relative z-10 text-center" >{title}<br /> <span className="text-gold" >{GoldTitle}</span></h1>
             {paragraph1 && (
              ...
              <Button onClick = {()=>ButtonFunction()} radius='full' className="relative z-10 mt-8 px-8 py-4 bg-gold text-black  font-nasa font-semibold hover:bg-primary/80 transition" >{ButtonText}</Button>
      </div>
  )
}
