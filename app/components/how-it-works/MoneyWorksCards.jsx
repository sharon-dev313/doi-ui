...
const MoneyWorksCards = ({icon , heading , paragraph}) => {
  return (
    <div className="bg-lightgraycard rounded-2xl p-6 shadow-sm border border-gray-100 flex gap-4 transition-all hover:shadow-md">
                                ...
                                <div>
                                    ...
                                    <p className="text-md text-default-600 leading-relaxed">
                                       {paragraph}
                                    </p>
                                </div>
                            </div>
